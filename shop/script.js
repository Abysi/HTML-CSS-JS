$(document).ready(function() {
      ...
      $(el).click(function() {
        ...
        setTimeout(function() {
          ...
          var cartItem =
            ...
            "' alt='' /></div><span>" +
            productName +
            "</span><strong>$100</strong><div class='cart-item-border'></div><div class='delete-item'></div></div>";
  ...
  $('#isArivals').click(function() {
      if(document.getElementById('isArivals').checked) {
          $(".Arivals").show();
          $(".Accesories").hide();
      } else {
          $(".Arivals").hide();
      }
      if(!document.getElementById('isArivals').checked && !document.getElementById('isAccesories').checked){
          $(".Arivals").show();
      }
      if(document.getElementById('isArivals').checked && document.getElementById('isAccesories').checked){
          $(".Arivals").show();
  ...
  $('#isAccesories').click(function() {
      if(document.getElementById('isAccesories').checked) {
          $(".Accesories").show();
          $(".Arivals").hide();
      } else {
          $(".Accesories").hide();
      }
      if(!document.getElementById('isAccesories').checked && !document.getElementById('isArivals').checked){
          $(".Accesories").show();
      }
      if(document.getElementById('isArivals').checked && document.getElementById('isAccesories').checked){
          $(".Arivals").show();
